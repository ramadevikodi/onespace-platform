 ...
 * the copyright owner.
 *
 * File name: HospitalSiteAdminAppListing.java
 */
...
@Component
public class HospitalSiteAdminAppListing implements RoleBasedAppListing {
    @Autowired
    ...
    public Page<ApplicationEntity> listApplications(IntrospectionResponse introspectionResponse, UUID statusId, Map<String, String> criteria, Pageable pageable) throws InvalidTokenException, ResourceNotFoundException {
        ...
        Page<ApplicationEntity> applicationEntities = listApplicationsOfHospital(introspectionResponse,
                specification,
                String.valueOf(RoleEnum.HOSPITALSITEADMINISTRATORROLE),
                pageable);
