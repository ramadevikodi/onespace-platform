 ...
 * the copyright owner.
 *
 * File name: ApplicationStatusController.java
 */
...
public class ApplicationStatusController {
	 ...
	 *
	 * @return the an list of application status objects.
	 */
	@ApiVersion("1")
	@RequestMapping(produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
	@RolesAllowed({ "EPO_APP.LIST" })
	public ResponseEntity<List<Value>> listApplicationStatus() throws BadRequestException {
		List<Value> applicationStatus = applicationStatusService.getApplicationStatus();
